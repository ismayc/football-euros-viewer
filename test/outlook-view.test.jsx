...
describe('OutlookView', () => {
  it('waits (no enumeration) when too many group games remain', () => {
    // Pre-tournament: all 36 group games unplayed → an enormous outcome space, far past the
    ...
    expect(container.querySelector('.bo-count')).toHaveTextContent('36 group games left')
  })
})
