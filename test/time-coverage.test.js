...
const ISO = '2024-06-14T20:00:00-04:00' // opener kickoff (ET)
...
describe('formatters', () => {
  ...
  it('formats a long date in a zone', () => {
    expect(formatDateLong(ISO, 'America/New_York')).toContain('2024')
  })

  it('produces a YYYY-MM-DD day key', () => {
    expect(dayKey(ISO, 'America/New_York')).toBe('2024-06-14')
  })
