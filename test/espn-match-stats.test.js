...
describe('applyLive carries the ESPN event id onto merged matches', () => {
  ...
  const liveMap = new Map([[pairKey('Denmark', 'Slovenia'), rec]])
  // M6 (Slovenia v Denmark, Group C), stated the way the feed reports it.
  const base = { num: 6, stage: 'Group', group: 'C', t1: 'Denmark', t2: 'Slovenia', ko: '2024-06-16T18:00:00+02:00' }
