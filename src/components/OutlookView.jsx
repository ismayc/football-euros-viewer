...
import { ENTRY_SLOT_LABELS, countRemaining } from '../utils/outlookEnum.js'
  ...
  return (
    <div className="bracket-odds">
      <div className="bo-intro">
        <p>
          For each open Round-of-16 spot, the share of the <strong>remaining outcomes</strong> that
      ...
      {phase === 'done' && result && (
        <>
          {allLocked && <p className="bo-note">✅ Every Round-of-16 matchup is now mathematically set.</p>}
          ...
          <div className="bo-grid">
            {nums.map((n) => {
              ...
              const labels = ENTRY_SLOT_LABELS[n]
              return (
          ...
          {hiddenAlive.length > 0 && (
            <div className="bo-alive" id="bo-alive-note">
              ...
              <p className="bo-alive-note">
                ...
                game. These teams can still reach the Round of 16, but only via a swing larger than
