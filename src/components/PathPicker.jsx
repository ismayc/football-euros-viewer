...
import { BRACKET, knockoutTeams, pathToFinal } from '../utils/bracket.js'
...
function summarize(path, byNum) {
  ...
  // Read the Final's number from the bracket rather than hardcoding it — the
  // number differs per competition, and getting it wrong sends the "champions"
  // case down the "through to the next round" branch, where there is no next
  // round to name.
...
// has reached the Round of 16, plus quick chips for followed teams, and a live
