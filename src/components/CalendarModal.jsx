...
const PROD = 'https://football-euros-viewer.netlify.app'
    ...
    <div className="md-overlay" onClick={onClose} role="dialog" aria-modal="true">
      <div className="md-card cal-modal" ref={cardRef} tabIndex={-1} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="md-section">
          ...
          <SubRow label="All 51 matches" httpsUrl={FEED} />
        ...
        <div className="md-section">
          ...
          <div className="cal-downloads">
            <button onClick={() => downloadICSCollection(matches, 'euro-2024-all.ics')}>
              All matches ({matches.length})
            </button>
            <button onClick={() => downloadICSCollection(filtered, 'euro-2024-filtered.ics')}>
              Current filter ({filtered.length})
            </button>
            {count > 0 && (
              <button onClick={() => downloadICSCollection(myMatches, 'euro-2024-my-teams.ics', 'Euro 2024 — My Teams')}>
