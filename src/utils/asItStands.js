...
export function projectKnockout(matches) {
  ...
  let official = false
  /* v8 ignore start -- unreachable: there are always exactly six thirds (one per committed group), so the qualifying set always has ADVANCING_THIRDS of them and the Annexe C table always answers */
