...
// locale. The pattern comes from the-nfl-schedule; this is one of the tournament viewers in the family;
// womens-world-cup-viewer got this shape first and the three share it.
//
...
export const LEAGUE = {
  id: 'euros',
  // The competition as the .ics summary prints it. UEFA styles it in caps. Used in .ics event summaries.
  name: 'EURO',
  // The full product title: index.html's <title> and the manifest's name.
  title: 'Euro 2024 — Schedule Viewer',
  ...
  coreSeasonPath: 'soccer/leagues/uefa.euro/seasons/2024',
  storageKey: 'euros', // 'euros:theme', 'euros:followed', 'euros:matchLines:<id>', …
  ...
  ics: {
    ...
    domain: 'footballeurosviewer',
    uidPrefix: 'euro2024-match-',
    filenameBase: 'euro-2024',
  },

  // Netlify serves /calendar.ics; GitHub Pages cannot run the function.
  feedHost: 'https://football-euros-viewer.netlify.app',
}
