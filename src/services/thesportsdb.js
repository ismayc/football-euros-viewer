...
export const BACKUP_SOURCE = {
  name: 'TheSportsDB',
  url: 'https://www.thesportsdb.com/league/4502-uefa-european-championship',
  homepage: 'https://www.thesportsdb.com/',
}

// Per-day results endpoint for one calendar date (YYYY-MM-DD).
export const sdbDayUrl = (d) => `https://www.thesportsdb.com/api/v1/json/3/eventsday.php?d=${d}&l=4502`
...
// TheSportsDB spellings that differ from ours, applied before normalizeTeam.
//
// Empty for Euro 2024: the only two divergences this feed has — "Czech Republic"
// and "Turkey" — are exactly the OpenFootball-style aliases normalizeTeam
// already maps, so there is nothing left for this table to do. Verified against
// the whole tournament and pinned by test/fixtures/sdb-team-names.json.
